...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/03 06:29:55 by narcisse          #+#    #+#             */
/*   Updated: 2023/10/04 01:09:36 by narcisse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_mutex(t_philo *ph)
{
    ...
    pthred_mutex_init(&ph->data.mutex_end, NULL);
}
/* This fucntion specificaly launch each philo with a left fork
   ...
   also the starting time, the philo eating_status and the number of philo are initialize */
